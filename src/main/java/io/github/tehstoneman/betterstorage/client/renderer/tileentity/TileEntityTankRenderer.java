...
public class TileEntityTankRenderer extends TileEntityRenderer< TileEntityTank >
{
	...
	public void render( TileEntityTank tileEntity, double x, double y, double z, float partialTicks, int destroyStage )
	{
		...
		if( !fluidStack.isEmpty() )
		{
			...
			//if( textureAtlas == null ) textureAtlas = Minecraft.getInstance().getTextureMap();
	...
	@Override
	public void render( TileEntityTank tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn,
