...
public class TileEntityLockerRenderer extends TileEntityRenderer< TileEntityLocker >
{
	...
	// KLprivate final ModelLocker largeLocker = new ModelLargeLocker();
			...
			int combinedOverlay )
	{
		...
		{
			final IBakedModel modelBase = modelManager.getModel(
					/* lockerType == ConnectedType.SINGLE ? */ Resources.MODEL_REINFORCED_LOCKER /* : Resources.MODEL_REINFORCED_LOCKER_LARGE */ );
			final IBakedModel modelDoor = modelManager.getModel(
					/*
					 * lockerType == ConnectedType.SINGLE
					 * ?
					 */ /* hingeSide == DoorHingeSide.LEFT ? */ Resources.MODEL_REINFORCED_LOCKER_DOOR_L /*
																											 * : Resources.MODEL_REINFORCED_LOCKER_DOOR_R
																											 * : hingeSide == DoorHingeSide.LEFT ?
																											 * Resources.MODEL_REINFORCED_LOCKER_DOOR_LARGE_L
			 ...
			 * lockerType == ConnectedType.SINGLE
			 * ? hingeSide == DoorHingeSide.LEFT ?
			 * Resources.MODEL_REINFORCED_LOCKER_DOOR_FRAME_L
			...
			blockRenderer.getBlockModelRenderer().renderModel( currentMatrix, renderBufferLocker, null, modelDoor, 1.0f, 1.0f, 1.0f, combinedLight,
					combinedOverlay, data );
			/*
