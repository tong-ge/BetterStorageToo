...
@OnlyIn( Dist.CLIENT )
public class GuiReinforcedChest// extends AbstractContainerScreen< ReinforcedChestContainer >
{
	/*
	 ...
	 * 
	 * public GuiReinforcedChest( ReinforcedChestContainer container, Inventory playerInventory, Component title )
	 * {
