...
public class ModelLocker extends ModelBase
{
	...
	protected ModelRenderer	lockerDoorLeft	= new ModelRenderer( this, 12, 0 ).setTextureSize( 64, 64 );
	protected ModelRenderer	lockerDoorRight	= new ModelRenderer( this, 12, 0 ).setTextureSize( 64, 64 );
	...
	public ModelLocker()
	{
		...
		lockerKnobLeft = new ModelRenderer( this, 0, 0 ).setTextureSize( 64, 64 );
		...
		lockerKnobRight = new ModelRenderer( this, 0, 0 ).setTextureSize( 64, 64 );
		...
		lockerBody = new ModelRenderer( this, 0, 18 ).setTextureSize( 64, 64 );
	...
	public ModelRenderer getDoor( boolean isLeftDoor )
	{
