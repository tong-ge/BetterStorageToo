...
public class ModelLargeLocker extends ModelLocker
{
	...
	{
		lockerDoorLeft = new RendererModel( this, 12, 0 ).setTextureSize( 64, 128 );
		...
		lockerKnobLeft = new RendererModel( this, 0, 0 ).setTextureSize( 64, 128 );
		...
		lockerDoorRight = new RendererModel( this, 12, 0 ).setTextureSize( 64, 128 );
		...
		lockerKnobRight = new RendererModel( this, 0, 0 ).setTextureSize( 64, 128 );
		...
		lockerBody = new RendererModel( this, 0, 34 ).setTextureSize( 64, 128 );
