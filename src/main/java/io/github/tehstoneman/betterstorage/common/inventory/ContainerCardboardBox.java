...
public class ContainerCardboardBox extends AbstractContainerMenu
{
	...
	public ContainerCardboardBox( int windowId, Inventory playerInventory, Level world, BlockPos pos )
	{
