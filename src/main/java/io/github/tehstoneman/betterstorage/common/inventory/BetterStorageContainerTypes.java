...
public final class BetterStorageContainerTypes
{
	...
	public static RegistryObject< ContainerType< ContainerCardboardBox > >		CARDBOARD_BOX		= REGISTERY.register( "cardboard_box",
			() -> IForgeContainerType.create( ( windowID, inv, data ) ->
																											{
																												final BlockPos pos = data
																														.readBlockPos();
																												return new ContainerCardboardBox(
																														windowID, inv,
			...
			() -> IForgeContainerType.create( ( windowID, inv, data ) ->
																											{
																												final BlockPos pos = data
																														.readBlockPos();
																												return new ContainerCrate( windowID,
																														inv,
																														Minecraft.getInstance().world,
																														pos );
																											} ) );
	public static RegistryObject< ContainerType< ContainerKeyring > >			KEYRING				= REGISTERY.register( "keyring",
			() -> IForgeContainerType.create( ( windowID, inv, data ) ->
																											{
																												final ItemStack keyring = data
																														.readItemStack();
																												final int protectedIndex = data
																														.readInt();
																												return new ContainerKeyring( windowID,
																														inv, keyring,
																														protectedIndex );
																											} ) );
			...
			() -> IForgeContainerType.create( ( windowID, inv, data ) ->
																											{
																												final BlockPos pos = data
																														.readBlockPos();
																												return new ContainerLocker( windowID,
																														inv,
																														Minecraft.getInstance().world,
																														pos );
																											} ) );
			...
			() -> IForgeContainerType.create( ( windowID, inv, data ) ->
																											{
																												final BlockPos pos = data
																														.readBlockPos();
																												return new ContainerReinforcedChest(
																														windowID, inv,
																														Minecraft.getInstance().world,
																														pos );
																											} ) );
			...
			() -> IForgeContainerType.create( ( windowID, inv, data ) ->
																											{
																												final BlockPos pos = data
																														.readBlockPos();
																												return new ContainerReinforcedLocker(
																														windowID, inv,
																														Minecraft.getInstance().world,
																														pos );
																											} ) );
