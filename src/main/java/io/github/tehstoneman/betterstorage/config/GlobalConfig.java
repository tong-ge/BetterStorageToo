...
import io.github.tehstoneman.betterstorage.config.setting.EnchantmentIdSetting;
...
public class GlobalConfig extends Config
{
	...
	public GlobalConfig( File file )
	{
		...
		new BooleanSetting( this, reinforcedChestEnabled, true, "tile.betterstorage.reinforcedChest.name" ).setHasComment( false )
		...
		new BooleanSetting( this, reinforcedLockerEnabled, true, "tile.betterstorage.reinforcedLocker.name" ).setHasComment( false )
				.setRequiresMcRestart( true );
		new BooleanSetting( this, craftingStationEnabled, true, "tile.betterstorage.craftingStation.name" ).setHasComment( false )
				.setRequiresMcRestart( true );
		...
		new BooleanSetting( this, cardboardSheetEnabled, true, "item.betterstorage.cardboardSheet.name" ).setHasComment( false )
				.setRequiresMcRestart( true );
		...
		new BooleanSetting( this, drinkingHelmetEnabled, true, "item.betterstorage.drinkingHelmet.name" ).setHasComment( false )
				.setRequiresMcRestart( true );
		new BooleanSetting( this, slimeBucketEnabled, true, "item.betterstorage.bucketSlime.name" ).setHasComment( false )
				.setRequiresMcRestart( true );

		// Cardboard items
		new BooleanSetting( this, cardboardHelmetEnabled, true, "item.betterstorage.cardboardHelmet.name" ).setHasComment( false )
				.setRequiresMcRestart( true );
		new BooleanSetting( this, cardboardChestplateEnabled, true, "item.betterstorage.cardboardChestplate.name" ).setHasComment( false )
				.setRequiresMcRestart( true );
		new BooleanSetting( this, cardboardLeggingsEnabled, true, "item.betterstorage.cardboardLeggings.name" ).setHasComment( false )
				.setRequiresMcRestart( true );
		new BooleanSetting( this, cardboardBootsEnabled, true, "item.betterstorage.cardboardBoots.name" ).setHasComment( false )
				.setRequiresMcRestart( true );
		new BooleanSetting( this, cardboardSwordEnabled, true, "item.betterstorage.cardboardSword.name" ).setHasComment( false )
				.setRequiresMcRestart( true );
		new BooleanSetting( this, cardboardPickaxeEnabled, true, "item.betterstorage.cardboardPickaxe.name" ).setHasComment( false )
				.setRequiresMcRestart( true );
		new BooleanSetting( this, cardboardShovelEnabled, true, "item.betterstorage.cardboardShovel.name" ).setHasComment( false )
				.setRequiresMcRestart( true );
		...
		// Crate settings
		enableCrateInventoryInterfaceSetting = new BooleanSetting( this, enableCrateInventoryInterface, true )
				.setComment( "If enabled, exposes a special block view of crates, so items can be moved in and out by automated systems." );
		...
		new IntegerSetting( this, cardboardBoxUses, 4 ).setValidRange( 0, Integer.MAX_VALUE ).setSynced()
				.setComment( "Number of times cardboard boxes can be picked up with items before they break. Use 0 for infinite uses." );
		...
		enableStationAutoCraftingSetting = new BooleanSetting( this, enableStationAutoCrafting, false ).setSynced()
				.setComment( "If enabled, automated systems can pull out of crafting stations and therefore auto-craft items." );
		stationAutocraftDelaySetting = new IntegerSetting( this, stationAutocraftDelay, 10 ).setValidRange( 0, Integer.MAX_VALUE )
