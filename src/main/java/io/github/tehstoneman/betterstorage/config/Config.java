...
import io.github.tehstoneman.betterstorage.config.setting.DoubleSetting;
import io.github.tehstoneman.betterstorage.config.setting.IntegerSetting;
import io.github.tehstoneman.betterstorage.config.setting.Setting;
...
public class Config
{
	...
	{
		final HashMap< String, Setting > tmp = new HashMap<>();
		for( final Entry< String, Setting > entry : getSettings().entrySet() )
	...
	{
		for( final Setting setting : syncedSettings )
